    ...
    <aside className="space-y-8">
      ...
      <div>
        ...
        <p className="mt-3 text-base leading-relaxed text-[var(--muted)] max-w-sm">
          Doğanın içinde özel masanızı ayırtın ve unutulmaz bir gastronomi
      ...
      {/* Bilgi kutuları */}
      <div className="rounded-2xl border border-[var(--beige)] bg-white/70 p-5 space-y-4">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm leading-relaxed text-[var(--dark)]">
              {address}
            </p>
          </div>
        </div>
