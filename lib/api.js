...
export const getCompany = () =>
  get('/company', { next: { revalidate: 3600, tags: ['company'] } });
export const getNavigation = () =>
  get('/navigation', { next: { revalidate: 3600, tags: ['navigation'] } });
export const getFooterNavigation = () =>
  get('/navigation?menu=footer-nav', {
    next: { revalidate: 3600, tags: ['footer-navigation'] },
  });
export const getMenu = () =>
  get('/menu', { next: { revalidate: 1800, tags: ['menu'] } });
export const getGallery = () =>
  get('/gallery', { next: { revalidate: 3600, tags: ['gallery'] } });
export const getFeaturedGallery = () =>
  get('/gallery/featured', { next: { revalidate: 3600, tags: ['featured'] } });
export const getTestimonials = () =>
  get('/testimonials', { next: { revalidate: 3600, tags: ['testimonials'] } });
export const getTeam = () =>
  get('/team', { next: { revalidate: 86400, tags: ['team'] } });
export const getFaqs = () =>
  get('/faqs', { next: { revalidate: 86400, tags: ['faqs'] } });
